...
public class CommonResult<T> {
    ...
    public static CommonResult success(String message, Object data, Long total, String type) {
        return new CommonResult(CommonConstant.Status.SUCCESS_CODE, message, true, data, total, type);
    }
    ...
    public static CommonResult success(String message) {
        return new CommonResult(CommonConstant.Status.SUCCESS_CODE, message, true, null, 0L);
    }
    ...
    public CommonResult(Integer code, String message, Boolean success, T data, Long total, String type) {
        this.code = code;
