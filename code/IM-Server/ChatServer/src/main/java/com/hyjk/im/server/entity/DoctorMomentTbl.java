 ...
 * @history:
 */
@TableName("doctor_moment_tbl")
public class DoctorMomentTbl implements java.io.Serializable {
    ...
    public String getCompressImages() {
        return compressImages;
    }

    public void setCompressImages(String compressImages) {
